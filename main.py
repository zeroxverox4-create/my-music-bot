...
YTDL_OPTIONS = {
    ...
    # 🔥 यूट्यूब को पूरी तरह ब्लॉक करने की सेटिंग:
    'allowed_extractors': ['soundcloud', 'soundcloud:search', 'generic', 'bandcamp', 'vimeo', 'twitch'],
}
...
async def play(ctx, *, search: str):
    ...
    try:
        ...
        # Always force SoundCloud search
        ...
        if not data:
            await msg.edit(content="❌ **SoundCloud पर यह गाना नहीं मिला। नाम थोड़ा बदल कर (उदा. Song + Artist) सर्च करें!**")
            return
        ...
        await msg.edit(content=f"⚠️ **Play Error:** SoundCloud पर यह गाना नहीं मिल पाया। कृपया स्पेलिंग या आर्टिस्ट का नाम सही लिखें!")
